    ...
    public:
        ...
        int findPos(const HashedObj & x) const { 
            ...
            while (array[currentPos].info != EMPTY && array[currentPos].element != x) { //Procura pela posição disponivel para inserir o elemento x
                //printf("Colisão detectada, iniciando metódo quadrático\n");
            ...
            //printf("Metódo quadrático finalizado\n");
            }
        ...
        void printHash(const HashedObj) {
            printf("Realizando impressão dos elementos na tabela: \n");
